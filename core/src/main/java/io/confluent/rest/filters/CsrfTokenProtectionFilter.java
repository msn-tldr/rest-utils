...
public class CsrfTokenProtectionFilter implements Filter {
  ...
  public void doFilter(
    ...
    log.error("MSN-rest-utils: do Filter in csrftoken");
    System.out.println("MSN-rest-utils: do Filter in csrftoken");

    // https://www.eclipse.org/jetty/documentation/jetty-11/operations-guide/index.html#og-protocols-proxy
    // getRemotePortAddr/Host/Port will return original client's info as per proxy-protocol.
    log.error(
        "MSN-rest-utils: getLocalAddr {} getLocalPort {} getServerName {} getServerPort {}"
    ...
    System.out.println(
        "MSN-rest-utils: getLocalAddr " + servletRequest.getLocalAddr() + " getLocalPort "
        + servletRequest.getLocalPort() + " getServerName " + servletRequest.getServerName()
        + " getServerPort " + servletRequest.getServerPort()
        + " getRemoteAddr " + servletRequest.getRemoteAddr()
        + "getRemoteHost " + servletRequest.getRemoteHost()
        + " getRemotePort " + servletRequest.getRemotePort());

    // servletRequest.getServletContext().setAttribute("my attribute", "myStuff");
    servletRequest.setAttribute("MSNCustomAttribute", "custom-attr");
